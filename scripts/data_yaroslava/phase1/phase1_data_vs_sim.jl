...
f = ROOTFile("/home/maros/Work/Phd/SNSensitivityEstimate/data/data/phase1_Yaroslava_v1_noDistinct/output.root")
...
begin
    ...
    begin
        ...
        safesave(joinpath(scriptsdir("data_yaroslava"),"phase1", "sum_spectrum.png"), f, px_per_unit = 5)
        f
...
let
    ...
    save(joinpath(scriptsdir("data_yaroslava/phase1"), "phase1_2e_spectrum_2nu.png"), f, px_per_unit = 5)
    f 
end
...
ff = ROOTFile("/home/maros/Work/Phd/SNSensitivityEstimate/data/data/phase1_Yaroslava_v1_noDistinct/output.root")
