...
tHalf: 3.4641222039042895e24
signalEff: 0.1814003
bkg count: 3.5822237473844676
best ROI:
  phi : (35, 175)
  sumE : (2700, 3000)
  dy : (0, 65)
...
tHalf: 1.4993706460444963e22
signalEff: 0.1216718
bkg count: 192972.11677042404
best ROI:
  phi : (15, 180)
  sumE : (300, 2300)
  dy : (0, 130)
...
tHalf: 5.598633973645355e21
signalEff: 0.0404195
bkg count: 152739.1700697518
best ROI:
  phi : (15, 180)
  sumE : (300, 1400)
  dy : (0, 150)
...
| $\nu\_R\nu\_L\beta\beta \, (K=0.5)$         | 150\,$\mu$Bq/m$^3$ | 6.27e22                     |
| $N\nu\beta\beta \, (m\_N=1500\~\text{keV})$ | 150\,$\mu$Bq/m$^3$ | 1.389e22                    |
| $N\nu\beta\beta \, (m\_N=500\~\text{keV})$  | 150\,$\mu$Bq/m$^3$ | 4.028e21                   |

# experimental

# RH050 same side
tHalf: 1.4982823710187554e22
signalEff: 0.1210483
bkg count: 191277.00066182783
best ROI:
  phi : (15, 180)
  sumE : (300, 2000)
  dy : (0, 150)
...
tHalf: 1.097770307637153e22
signalEff: 0.0640228
bkg count: 99673.35368378887
best ROI:
  phi : (2.950543923938923, 179.75751510364515)
  sumE : (308.3670923843348, 2669.398672921722)
  dy : (0.0018990745719024056, 149.8304642381559)
  dz : (0.0001570941189869454, 149.99316468616303)
  sameSide : (0.0, 1.0)
  lPint : (0.0, 2.690136006552256)
  lPext : (1.0034679543406446, 50.0)
