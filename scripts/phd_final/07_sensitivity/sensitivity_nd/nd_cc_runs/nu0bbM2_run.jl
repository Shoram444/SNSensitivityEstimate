...
now = Dates.now()
const signal_name = "bb0nuM2_foil_bulk"
...
open(scriptsdir("phd_final/07_sensitivity/sensitivity_nd/nd_cc_runs/results/20260123_results/$(now)_$(signal_name)_$(rand(1:1000000))_radon_config_$(radon_tag).csv"), "w") do io
