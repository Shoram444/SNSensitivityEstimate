...
Xi31_foil_bulk_SumE     = Process(Xi31_foil_bulk.reconstructedEnergy1 .+ Xi31_foil_bulk.reconstructedEnergy2, sumEXiParams)
...
#Xi31
    plot(Xi31_foil_bulk_SumE.efficiency, title ="sum E Efficiency for "* Xi31_foil_bulk_SumE.isotopeName)
    safesave(plotsdir("SumE", savename("efficiency_sumE_", Xi31_foil_bulk_SumE, allowedtypes = (String, StepRange), "png")), current())
end
